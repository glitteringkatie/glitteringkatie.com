...
const Layout = ({ page = 'home', children, post }: Props) => {
  ...
  const workLifeLabelClasses = classNames([
    'text-warmBlack',
    'text-2xl',
    'sm:text-4xl',
    'font-serif',
  ...
  const padding = page === 'home' ? 'py-8 md:pt-16' : 'py-8';
      ...
      <div className="flex justify-center pb-3">
        <Link href="https://twitter.com/glitteringkatie">
          <a
            ...
            aria-label="@glitteringkatie on twitter">
        ...
        <header className={classNames([padding])}>
          ...
          <div className="flex items-center justify-center">
            ...
            <input
              ...
              onChange={event =>
                setBalanceValue(event.target.value as BalanceCategory)
              }
            />
